    ...
    <main className="bg-gradient-to-b from-slate-50 to-slate-100 text-slate-900">
      ...
      <section className="pt-20 pb-14">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <button className="inline-flex items-center gap-2 px-8 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-lg font-semibold shadow-lg hover:scale-105 transition">
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition">
              ...
              <p className="text-sm text-slate-500 mb-3">4–5 класс</p>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition">
              ...
              <p className="text-sm text-slate-500 mb-3">6–8 класс</p>
              <ul className="space-y-2 text-slate-700">
                <li>• Живые диалоги</li>
