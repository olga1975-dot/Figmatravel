export default function App() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0f172a] via-[#020617] to-black text-white font-sans">

      {/* HERO */}
      <section className="flex flex-col items-center justify-center text-center px-6 py-32">
        <span className="mb-4 rounded-full bg-emerald-500/20 px-4 py-1 text-sm text-emerald-300">
          Курс английского языка
        </span>

        <h1 className="max-w-3xl text-4xl font-bold leading-tight sm:text-5xl text-white">
        ...
        <button className="mt-10 rounded-xl bg-emerald-500 px-8 py-4 text-lg font-semibold text-black hover:bg-emerald-400 shadow-lg shadow-emerald-500/30 transition">
          Записаться на курс
        </button>
      </section>
      ...
      <section className="px-6 py-24 bg-black/40">
        ...
        <div className="mx-auto grid max-w-4xl gap-6 sm:grid-cols-2">
          ...
          <div className="rounded-2xl border border-emerald-400/40 bg-emerald-400/10 p-6 backdrop-blur">
      ...
      {/* PROGRAM */}
      <section className="px-6 pb-32 bg-black/40">
        <h2 className="mb-12 text-center text-3xl font-bold text-emerald-400">
          Программа курса
        </h2>
